...
const updateOrderBtn = document.getElementById("update_order");
let posOrder = [];
var today = new Date();
...
ipcRenderer.on("VatForEdit", (e, result) => {
  result.map((vatWithId) => {
    ...
    document.getElementById("place_neworder").style.display = "none";
...
function updateOrder(orderId) {
  ...
  // document.getElementById("place_neworder").style.visibility = "visible";
  // document.getElementById("update__order").style.visibility = "hidden";
}
